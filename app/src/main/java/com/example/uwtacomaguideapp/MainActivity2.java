...
//            textview2.setText(lng);
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        // 0.00418, -0.00508
        //432, 376
        if((lng1 >= -122.44131 && lng1 <= -122.43294) && (lat1 <= 47.24844 && lat1 >= 47.24258)){
            ...
            lat1 = Math.floor( 1220 * (1 - (((lat1 - 47.24258) * 100000) / 586)));
            lng1 = Math.floor(1000 * (((lng1 - (-122.44121)) * 100000) / 837));
