...
//            textview2.setText(lng);
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        // 0.00418, -0.00508
        //432, 376
        if((lng1 >= -122.44131 && lng1 <= -122.43223) && (lat1 <= 47.24783 && lat1 >= 47.24258)){
            ...
            lat1 = Math.floor( 1220 * (1 - (((lat1 - 47.24258) * 100000) / 525)));
            lng1 = Math.floor(1000 * (((lng1 - (-122.44131)) * 100000) / 898));
